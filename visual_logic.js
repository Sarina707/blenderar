...
createCSSRule('.enter-AR-button', "position: absolute; display: block; z-index: 1; background-color: rgba(255,255,255,0); width: 200px; height: 50px; bottom: 20px; left: 50%; margin-left: -100px; background-size: 100%; cursor: default; outline: none;", false, '');
...
setHTMLElemAttribute('href', 'https://milgram.jp/', 'info_button', false);
...
operateAnimation('PLAY', 'sarina_armature', 0, 50, 'LoopRepeat', 1,
        function() {}, false);


registerOnClick('sarina_mesh', false, false, [0,1,2], function() {

  operateAnimation('STOP', 'sarina_armature', null, null, 'AUTO', 1,
          function() {}, false);

      playSound(loadVideo('sounds/hello.mp3'), false);

  operateAnimation('PLAY', 'sarina_armature', 51, 90, 'LoopOnce', 1,
          function() {
...
checkARMode(function() {
  eventHTMLElem('pointerup', 'enter_AR_button', false, function(event) {
    enterARMode('ORIGIN', true, function() {
      changeVis(['GROUP', 'sarina_group'], false);
      ...
      changeVis(['GROUP', 'sarina_group'], true);
      changeVis('prompt_move_around', false);
      setObjTransform('sarina_armature', false, 'position', createVector(0, 0, 0), false);
      ...
      setObjTransform('sarina_armature', false, 'scale', [1, 1, 1], false);
  ...
  setHTMLElemAttribute('href', exportToUSDZ('sarina_mesh'), 'enter_AR_button', false);
  setHTMLElemAttribute('rel', 'ar', 'enter_AR_button', false);
  setHTMLElemAttribute('download', 'sarina.usdz', 'enter_AR_button', false);
}, function() {
  eventHTMLElem('pointerup', 'enter_AR_button', false, function(event) {
...
registerOnClick('indicator_invis_plane', false, false, [0,1,2], function() {
  changeVis(['GROUP', 'sarina_group'], true);
  setObjTransform('sarina_armature', false, 'position', [arHitPoint('x'), arHitPoint('y'), arHitPoint('z')], false);
  setObjDirection('sarina_armature', getObjTransform('Camera', false, 'position', 'xyz'), true, true);
...
registerOnDrag('drag_move', false, [0,1,2], function() {}, function() {
  dragMoveAdv('sarina_armature', 'XY', 'WORLD', '4I:4t*j,rX(PPCCr$+;F', ')L~m02sT=F?7O4H#IumH');
}, function() {}, ')L~m02sT=F?7O4H#IumH');

registerOnDrag('drag_rotate', false, [0,1,2], function() {}, function() {
  dragRotateAdv('sarina_armature', 'X', 'WORLD', '~qRSSOrL%[~x3g3k3-oK', '#!q9O!p]F.eBGR!|c?t6');
}, function() {}, '#!q9O!p]F.eBGR!|c?t6');

registerOnDrag('drag_rotate', false, [0,1,2], function() {}, function() {
  dragScale('sarina_armature', 'Z', '%ulUm6ftBF7h]u,D^mXJ', '*X/*9Re%=vRbu#5|6t4T');
  dragScale('sarina_armature', 'X', 'o$2P3PBi@JXt9K([YZf=', '*X/*9Re%=vRbu#5|6t4T');
  dragScale('sarina_armature', 'Y', '6$Csbw0#H7Q,UPQjvATG', '*X/*9Re%=vRbu#5|6t4T');
  updateTextObj('scale_percentage', String(Math.round(toFixedPoint(getObjTransform('sarina_armature', false, 'position', 'z'), 2) * 100)) + '%');
}, function() {}, '*X/*9Re%=vRbu#5|6t4T');
